/*******************************************************************/
/* This will show you how to create a new process with clone and   */
...
int main(){
	...
	void * child_stack ;
	variable = 10;
	printf("Value of variable in parent : %d", variable);
	/*get memory for child stack*/
	child_stack  = malloc(STACK_SIZE);
	if(child_stack == NULL){
		printf("Error in allocating the size for child");
		exit(1);
	}
